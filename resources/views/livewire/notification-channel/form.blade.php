<div class="space-y-6">
    ...
    <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-4 bg-white dark:bg-zinc-900 max-w-xl mx-auto">
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <flux:field>
                ...
                <select wire:model="auth_type" class="w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-200 dark:border-neutral-700 dark:bg-zinc-900 dark:text-neutral-100">
            ...
            <div class="flex items-center gap-2 mt-4">
                <flux:button type="submit" variant="primary">{{ $channelId ? __('Update') : __('Create') }}</flux:button>
